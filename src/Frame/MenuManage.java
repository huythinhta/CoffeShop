...
//        System.out.println(id);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(rootPane, "Chưa chọn đối tượng sửa");
        try {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            if (isNullOrEmpty(txtName.getText()) == false) {
                DialogHelper.alert(this, "Thiếu tên đồ uống");
                return;
            }
            ...
            if (isNullOrEmpty(txtPrice.getText()) == false) {
                DialogHelper.alert(this, "Thiếu giá tiền");
                return;
            }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(rootPane, "Chưa chọn đối tượng xóa");
        if(lblname.equals("Quản lý"))
        {
        ...
        load();
            ...
            JOptionPane.showMessageDialog(rootPane, "bạn ko có quyền xóa");
        }
